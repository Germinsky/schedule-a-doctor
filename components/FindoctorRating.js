...
import ConfirmVisitPre from './ConfirmVisitPre.js'
...
{
this.props.navigation.navigate('ConfirmVisitPre',{name:name,clinic:clinic,time:time,duration:duration});
}
  ...
  oniconbl()
  {
    this.props.navigation.navigate('Doctormenu');//n
