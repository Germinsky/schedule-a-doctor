...
export default class DashBoard extends React.Component<props> {
  ...
  onURGENT() {
   ...
   onicontr() {
   this.props.navigation.navigate('UrgentScreen');
   // Alert.alert('Select how urgently you want to schedule a visit to doctor from the option');
     }
  onPREVENTATIVE() {
       ...
       <CardFlip style={[styles.buttonContainer,{alignSelf:'center',alignItems:'center',backgroundColor:'#fff'}]} ref={(card) => this.card = card} >
          ...
          <View style={[styles.innercontainer,{alignItems:'center'}]}>
            ...
            <Text
			  ...
			  Select how urgently you want to schedule a visit to doctor from the options available
          ...
          <TouchableHighlight style={[styles.cardButton, styles.bottomLeft]}>
            ...
            style={[styles.cardButton, styles.bottomRight]}  
            onPress={() => this.card.flip()}>
