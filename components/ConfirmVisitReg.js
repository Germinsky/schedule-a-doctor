...
import VisitDoctorReg from './VisitDoctorReg.js'
import FindoctorReg from './FindoctorReg.js'
import CardFlip from 'react-native-card-flip';
import Dialog from "react-native-dialog";
import styles from './style.js';
export default class ConfirmVisitReg extends Component {
  state = {
    dialogVisible: false,
    modalVisible: false,
  };
...
alert(name,clinic,time,duration)
{
 ...
 this.props.navigation.navigate('VisitDoctorReg',{name:name,clinic:clinic,time:time,duration:duration });
}
alertback()
{
